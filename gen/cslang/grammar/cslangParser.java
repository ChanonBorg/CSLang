...
public class cslangParser extends Parser {
	...
	public static class PruleContext extends ParserRuleContext {
		public TerminalNode CHAR() { return getToken(cslangParser.CHAR, 0); }
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof cslangListener ) ((cslangListener)listener).enterPrule(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof cslangListener ) ((cslangListener)listener).exitPrule(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof cslangVisitor ) return ((cslangVisitor<? extends T>)visitor).visitPrule(this);
